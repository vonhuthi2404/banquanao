            ...
            <main>
                <div class="container">
                   ...
                   <div class="info mt-3 d-flex">
                    ...
                    <p style="padding-left: 1vw; color: #66a182;">Áo sơ mi</p>
                   </div>   
                    <hr>
                   ...
                   <div class="row justify-content-between mt-3">
                    ...
                    <div class="col-6  ">
                        ...
                        <img style="width: 100%; border-right: 1px solid #ccc;" src="../images/product_2.webp" alt="">
                    ...
                    <div class="col-6  ">
                        ...
                        <del>650.000₫</del>
                        <hr class="mt-3">
                        <label class="mt-4" for=""> <strong>Size</strong></label><br>

                        <select class="product_size" name="" id="">
                            <option value="">M</option>
                            <option value="">L</option>
                            <option value="">XL</option>
                        </select>

                        <label class="mt-4" for=""><strong>Màu sắc</strong></label><br>
                        <select style="width: 100%; height: 3vw; padding-left: 1vw; border: #ccc 1px solid;" name="" id="">
                            <option value="">TRắng</option>
                            <option value="">Đen</option>
                            <option value="">Nâu</option>
                        </select>
                        <div class="quantity d-flex mt-4">
                            <label for=""><strong>Số lượng</strong></label><br>
                            <input style="width:8vw; height: 3vw;" type="text" value="1">

                            <input style="margin-left: 1vw; border: none; background: #66a182; color: white;" type="submit" value="Thêm vào giỏ hàng">
                        </div>
