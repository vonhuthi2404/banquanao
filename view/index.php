            ...
            <main>
                        ...
                        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                              <div class="carousel-item active" data-bs-interval="3000">
                                <img src="../images/benner_1.webp" style="height: 32vw;" class="d-block w-100" alt="...">
                              </div>
                              <div class="carousel-item" data-bs-interval="3000">
                                <img src="../images/benner_2.webp" style="height: 32vw;" class="d-block w-100" alt="...">
                              </div>
                ...
                <div class="product-1 my-4">
                    ...
                    <div class="row ">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="./usercontroller.php?act=product_details"><img style="width: 100%; height: 22vw;" src="../images/product_1.webp" alt=""></a>
                            <p class=" text-center pt-2 m-0">Áo phông vigate trắng</p>
                            <div class="price text-center ">
                                <strong class=" color-logo ">255.000d</strong>
                                <del style="color: #828181;" >300.000d</del>
                            </div>

                        </div> 
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="./usercontroller.php?act=product_details"><img style="width: 100%; height: 22vw;" src="../images/product_2.webp" alt=""></a>
                            <p class=" text-center pt-2 m-0">Áo phông vigate trắng</p>
                            <div class="price text-center " >
                                <strong class=" color-logo ">255.000d</strong>
                                <del style="color: #828181;" >300.000d</del>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="./usercontroller.php?act=product_details"><img style="width: 100%; height: 22vw;" src="../images/product_3.webp" alt=""></a>
                            <p class=" text-center pt-2 m-0">Áo phông vigate trắng</p>
                            <div class="price text-center " >
                                <strong class=" color-logo ">255.000d</strong>
                                <del style="color: #828181;" >300.000d</del>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="./usercontroller.php?act=product_details"><img style="width: 100%; height: 22vw;" src="../images/product_4.webp" alt=""></a>
                            <p class=" text-center pt-2 m-0">Áo phông vigate trắng</p>
                            <div class="price text-center " >
                                <strong class=" color-logo ">255.000d</strong>
                                <del style="color: #828181;" >300.000d</del>
                ...
                <div class="banner-sp">
                    <div class="container">
                        <div class="row    justify-content-between  ">
                            <div class="col-6">
                                <img style="width: 100%; height: 15vw;" src="../images/banner_sp_1.webp" alt="">
                            </div>
                            <div class="col-6">
                                <img style="width: 100%; height: 15vw;" src="../images/banner_sp_2.webp" alt="">
                            </div>
                        </div>
                    </div>
                </div>

                <div class="product-2 my-4">
                    <div class="tile-spm">
                        <div class="container">
                    ...
                    <div class="row ">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                           <a href="./usercontroller.php?act=product_details"> <img style="width: 100%; height: 22vw;" src="../images/product_5.webp" alt=""></a>
                            <p class=" text-center pt-2 m-0">Áo phông vigate trắng</p>
                            <div class="price text-center " >
                                <strong class=" color-logo ">255.000d</strong>
                                <del style="color: #828181;" >300.000d</del>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="./usercontroller.php?act=product_details"><img style="width: 100%; height: 22vw;" src="../images/product_6.webp" alt=""></a>
                            <p class=" text-center pt-2 m-0">Áo phông vigate trắng</p>
                            <div class="price text-center " >
                                <strong class=" color-logo ">255.000d</strong>
                                <del style="color: #828181;" >300.000d</del>
                ...
                <div class="banner-sp">
                    <div class="container">
                        <div class="row    justify-content-between  ">
                            <div class="col-12">
                                <img style="width: 100%; height: 15vw;" src="../images/banner_sp_3.webp" alt="">
                            </div>
