            ...
            <main>
                <div class="container">
                   ...
                   <div class="info mt-3 d-flex">
                    ...
                    <p style="padding-left: 1vw; color: #66a182;">Tin tức</p>
                   </div>
                   <div class="info-1">
                    <hr>
                   <h5 class="mt-3">TIN TỨC</h5>
                   </div>
                   ...
                   <div class="row justify-content-between">       
                    <div class="col-6  ">
                        <div class="new mt-3">
                           ...
                           <a href=""><img style="width:100%" src="../images/new_1.webp" alt=""></a>
                        </div>
                            <div class="new-introduce mt-4">

                            <span style="font-size: 2vw;" >Khi thời trang là thảm họa thì sẽ như thế nào ?</span>
                            <p>Trong các tuần lễ thời trang, ngoài thời trang của các sao là vấn đề gây chú ý 
                                thì thời trang của các fashionista cũng là một chủ đề được...</p>
                            </div>
                            </div>
                        <div class="submitt">
                            <div class="row mt-3">
                                <div class="col-3">
                                    <a href="">
                                        <input style="width: 8vw; height: 3vw; background: #66a182; border: none;color:white; " type="button" value="Đọc tiếp">
                                        <hr>
                                    </a>
                                </div>
                        ...
                        <div class="new mt-3">
                           ...
                           <a href=""><img style="width:100%" src="../images/new_3.webp" alt=""></a>
                        </div>
                            <div class="new-introduce mt-4">

                            <span style="font-size: 2vw;" >Dàn siêu mẫu trình diễn thời trang mùa thu tại London</span>
                            <p>Trong các tuần lễ thời trang, ngoài thời trang của các sao là vấn đề gây chú ý 
                                thì thời trang của các fashionista cũng là một chủ đề được...</p>
                            </div>
                            </div>
                    ...
                    <div class="col-6  ">
                        <div class="new mt-3">
                           ...
                           <a href=""><img style="width:100%" src="../images/new_4.webp" alt=""></a>
                        </div>
                            <div class="new-introduce mt-4">

                            <span style="font-size: 2vw;" >Khi thời trang là thảm họa thì sẽ như thế nào ?</span>
                            <p>Bước ra khỏi ghế nhà trường, chúng ta sẽ thay đổi để hòa nhập với môi trường sống lẫn công việc mới. Song đến lúc bạn gặp lại đối phương...</p>
                            </div>
                            </div>
                        <div class="submitt">
                            <div class="row mt-3">
                        ...
                        <div class="new mt-3">
                           ...
                           <a href=""><img style="width:100%" src="../images/new_2.webp" alt=""></a>
                        </div>
                            <div class="new-introduce mt-4">

                            <span style="font-size: 2vw;"> Tại sao càng trưởng thành, bạn bè lại càng xa nhau? </span>
                            <p>Bạn thích những bộ váy giống như mẹ hay mặc ngày xưa? Cách phối đồ phong cách vintage chính là gợi ý cho bạn trở thành một phiên bản đáng...</p>
                            </div>
                            </div>
                        <div class="submitt">
                            <div class="row mt-3">
