            ...
            <main>
                <div class="container">
                   ...
                   <div class="info mt-3 d-flex">
                    ...
                    <p style="padding-left: 1vw; color: #66a182;">Đăng nhập tài khoản</p>
                   </div>
                   <div class="info-1">
                    <hr>
                   ...
                   <div class="row justify-content-between">
                    ...
                    <div class="col-6  ">
                        <form action="">
                            ...
                            <input  style="width: 100%; height: 3vw; border: #ccc solid 1px; margin-top: 1vw;" type="text" name="" id="">
                        ...
                        <div class="submitt">
                            <div class="row mt-5">
                                <div class="col-3">
                                    <a href="./usercontroller.php?act=register">
                    ...
                    <div class="col-6  ">
                        <div class="tile">
                            ...
                            <p class="mt-4" style="color: #797979;">
                                Đăng ký tài khoản ngay để có thể mua hàng nhanh chóng và dễ dàng hơn ! Ngoài ra
                                 còn có rất nhiều chính sách  và ưu đãi cho các và ưu đãi cho các thành viên Vemouse
                            </p>
                        </div>
                        <div class="submitt">
                            <div class="row mt-4">
                                <div class="col-3">
                                    <a href="">
                                        <input style="width: 8vw; height: 3vw; background: #000000b0; border: none;color:white; " type="button" value="Đăng ký">
                                    </a>
                                </div>
